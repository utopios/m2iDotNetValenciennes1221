...
namespace PassageParams
{
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             * Le Passage d'arguments peut se faire par référence ( pour les variables de type objet => Copie de la valeur)
             ...
             * REF=> Pour passer une valeur par référence => Afin de modifier sa valeur
             * OUT=> Pour Ecrire la valur en sortie de la fonction 
             */
