...
namespace CorrectionExercice14
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if ((taille >= 145 && taille <= 160 && poids >= 43 && poids <= 65) || (taille == 163 && poids >= 43 && poids <= 59) || (taille == 166 && poids >= 43 && poids <= 53) || (taille == 169 && poids >= 43 && poids <= 47))
                tailleVet = 1;
            ...
            if (tailleVet == 0)
                ...
                Console.WriteLine($"prenez la taile {tailleVet}");
        }
    }
}
